...
// ****************************************************************
//Fill in the missing parts (Ans 1 - 5) to complete the program

//I acknowledge that I have read and understand the course policy
//concerning assignment and program submission
...
void Ant::breed()
{
	...
	if (breedTicks == ANTBREED)
	{
		...
		else if ((x<WORLDSIZE-1) && (world->getAt(x+1,y)==NULL))  //right
		{
         Ant *newAnt = new Ant(world, x+1, y);
      }
	}
